function iniciarApp() {
    ...
    function mostrarRecetaModal(receta) {
        ...
        for(let i = 1; i <= 20; i++) {
            //console.log(receta[`strIngrediente${i}`])
    ...
    function eliminarFavorito(id) {
        ...
        // Eliminar de la pagina mis favoritos
        if(favoritosDiv){
    ...
    function mostrarToast(mensaje) {
        ...
        const toastBoby = document.querySelector('.toast-body');
        const toast = new bootstrap.Toast(toastDiv);

        toastBoby.textContent = mensaje;
    ...
    function obtenerFavoritos() {
        ...
        noFavoritos.classList.add('fs', 'text-center', 'font-bold', 'mt-5');
